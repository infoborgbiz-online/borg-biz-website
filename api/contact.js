module.exports = async function handler(req, res) {
    ...
    try {
        ...
        const createXml = `<?xml version="1.0"?><methodCall><methodName>execute_kw</methodName><params><param><value><string>${ODOO_DB}</string></value></param><param><value><int>${uid}</int></value></param><param><value><string>${ODOO_API_KEY.trim()}</string></value></param><param><value><string>crm.lead</string></value></param><param><value><string>create</string></value></param><param><value><array><data><value><struct><member><name>name</name><value><string>${leadNaam}</string></value></member><member><name>contact_name</name><value><string>${naam}</string></value></member><member><name>email_from</name><value><string>${email}</string></value></member><member><name>description</name><value><string>${omschrijving}</string></value></member><member><name>type</name><value><string>opportunity</string></value></member><member><name>company_id</name><value><int>3</int></value></member></struct></value></data></array></value></param><param><value><struct></struct></value></param></params></methodCall>`;
